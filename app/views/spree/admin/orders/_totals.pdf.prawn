...
totals << [Prawn::Table::Cell.new( :text => t('spree.subtotal'), :font_style => :bold), @order.display_item_total.to_s]
...
totals << [Prawn::Table::Cell.new( :text => t('spree.order_total'), :font_style => :bold), @order.display_total.to_s]
